...
<!-- wp:group -->
<div class="wp-block-group category-medical-banner">
...
<!-- /wp:image -->
<!-- wp:group -->
<div class="wp-block-group category-medical-banner-header">
    <!-- wp:paragraph -->
            ...
            <div class="wp-block-group category-medical-product-item product-col-2">
                ...
                <div class="wp-block-group category-medical-product-detail">
                    ...
                    <div class="wp-block-group category-medical-product-content">
                        ...
                        <a class="product-item-link" href="../products/famubo-z/" target="_blank">
                            <img src="<?php echo esc_url( get_theme_file_uri('assets/images/top_products/products_37_n.jpg') ); ?>" alt="FAMUBO-Z 超音波画像機器 超音波画像機器（皮下脂肪厚 筋厚）" class="wp-image-66"/></a>
                        </figure>
                        <!-- /wp:image -->
                        <!-- wp:paragraph -->
                        <p class="product-item-name">FAMUBO-Z</p>
                        <!-- /wp:paragraph -->
                    ...
                    <div class="wp-block-group category-medical-product-content">
                        <!-- wp:image {"id":66,"sizeSlug":"large","linkDestination":"none"} -->
                        <figure class="wp-block-image size-large">
                        <a class="product-item-link" href="../products/famubo-cs/" target="_blank">
                            <img src="<?php echo esc_url( get_theme_file_uri('assets/images/top_products/products_38_n.jpg') ); ?>" alt="FAMUBO-CS 超音波画像機器 超音波画像機器（皮下脂肪厚 筋厚）" class="wp-image-66"/></a>
                        </figure>
                        <!-- /wp:image -->
                        <!-- wp:paragraph -->
                        <p class="product-item-name">FAMUBO-CS</p>
                        <!-- /wp:paragraph -->
