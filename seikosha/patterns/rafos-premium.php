...
<div class="wp-block-group product-page rafos-premium">
    ...
    <div class="wp-block-group intro">
        ...
        <div class="wp-block-group inner">
            ...
            <!-- /wp:image -->
            <!-- wp:paragraph -->
            <p class="catch">1台3役<br>
                いままでの高周波とは実力が違う!!</p><!-- /wp:paragraph -->
            <!-- wp:group -->
            <div class="wp-block-group herfbox">
                ...
                <div class="wp-block-group herf_l">
                    ...
                    <div class="wp-block-group read">
                        ...
                        <!-- wp:paragraph -->
                        <p class="list_maru">立ち上がり10秒の高速スタート<br>
                            0～99%まで1%ずつのパワー調整機能<br>
                            ゼロスタートと電流防止システムによる安全性<br>
                            赤外線センサーによる自動温度設定システム<br>
                            6つのモードで温熱から弱温熱までのプログラム<br>
                            優れた熱制御と静音性を考慮した設計<br>
                        </p><!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
    ...
    <!-- /wp:group -->
    <!-- wp:group -->
    <div class="wp-block-group youtube_r mt20 mb20">
        <!-- wp:embed {"url":"https://youtu.be/zBRL8z_00pw","type":"video","providerNameSlug":"youtube","responsive":true,"className":"wp-embed-aspect-16-9 wp-has-aspect-ratio"} -->
        <figure class="wp-block-embed is-type-video is-provider-youtube wp-block-embed-youtube wp-embed-aspect-16-9 wp-has-aspect-ratio">
            <div class="wp-block-embed__wrapper">
                https://youtu.be/zBRL8z_00pw
            </div>
        </figure>
        <!-- /wp:embed -->
    </div>
    ...
    <div class="wp-block-group symptom">
        ...
        <div class="wp-block-group inner">
            ...
            <div class="wp-block-group rf_denkyoku">
                <!-- wp:group -->
                <div class="wp-block-group rf_denkyoku_item">
                    <!-- wp:image -->
                    <figure class="wp-block-image">
