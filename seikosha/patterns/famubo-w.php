...
/**
 * Title: Famubo W Product
 * 
 * Slug: themeslug/product-famubo-w
...
<!-- wp:group -->
<div class="wp-block-group product-page famubo-w-page">
    <!-- wp:group -->
    <div class="wp-block-group product-page-top">
        ...
        <div class="wp-block-group product-page-top-inner">
            ...
            <div class="wp-block-group product-page-top-left">
                <!-- wp:paragraph -->
                <p class="product-page-top-left-header">FAMUBO-W</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p class="product-page-top-left-sub">ファンボ ダブリュー</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
    ...
    <div class="wp-block-group product-header-title">
        ...
        <div class="wp-block-group product-header-list">
            ...
            <!-- wp:paragraph --><p class="product-title-header">FAMUBO-W</p><!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
    </div>
    <!-- /wp:group -->
        ...
        <div class="wp-block-group product-intro-inner">
            ...
            <div class="wp-block-group product-intro-content">
                ...
                <div class="wp-block-group product-intro-content-item">
                    <!-- wp:paragraph --><p class="product-intro-content-read bold">256エレメンツ高画素、ワイドタイプ！ドップラー機能付登場!!
圧倒的な高画素による鮮明画像とプローブ面85ｍｍの迫力画面!!</p><!-- /wp:paragraph -->
                    <!-- wp:paragraph --><p class="product-intro-content-read">小型可動式で測定面ワイドな「FAMUBO」シリーズにカラードップラー＆高画素機能が付いた「FAMUBO-W」登場。
256エレメンツとFAMUBO至上最大の画像を有しており、ヘッド幅85mmとワイド迫力ある画面を一度に観察が可能です。スポーツ領域や整形領域、美容外科等の脂肪や皮下の観察にも最適です。</p><!-- /wp:paragraph -->
                    <!-- wp:group -->
                    <div class="wp-block-group product-intro-content-video">
                        <!-- wp:video {"id":178} -->
                            <figure class="wp-block-video block-video"><video autoplay="" muted="" loop="" src="<?php echo esc_url( get_theme_file_uri( 'assets/videos/famubo/famubo_w.mp4' ) ); ?>"></video></figure>
                        <!-- /wp:video -->
                    </div>
                    <!-- /wp:group -->
                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                    <figure class="wp-block-image size-large alignfull product-intro-content-image">
                        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-w/img01.jpg' ) ); ?>" alt="腓腹筋画像 超音波画像" class="wp-image-101"/>
                    </figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:group -->
                ...
                <div class="wp-block-group product-intro-content-item content-right">
                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                    <figure class="wp-block-image size-large alignfull product-intro-content-image">
                        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-w/body.jpg' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-W」" class="wp-image-101"/>
                    </figure>
                    <!-- /wp:image -->
                    <!-- wp:table -->
                    <figure class="wp-block-table product-intro-content-table">
                        <table class="has-fixed-layout">
                            ...
                            <tbody>
                                <tr>
                                    <td>サイズ</td>
                                    <td>本体<br>85(W)×24(H)×156(L) mm</td>
                                </tr>
                                <tr>
                                    <td>重　量</td>
                                    <td>0.3kg</td>
                                ...
                                <tr>
                                    <td>測定深度</td>
                                    <td>linear20-50mm(20/40/60/100)
                                    /Display Mod B/ Color</td>
                                </tr>
                                <tr>
                                    <td>動作環境</td>
                ...
                <div class="wp-block-group product-information">
                    ...
                    <article class="wp-block-group product-information-item">
                        ...
                        <div class="wp-block-group product-information-banner-kv">
                            <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                            <figure class="wp-block-image size-large alignfull product-information-banner-kv-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-w/kv.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」カラードップラーで血流の流速変化を確認！" class="wp-image-101"/></figure>
                            <!-- /wp:image -->
                        </div>
                        <!-- /wp:group -->
                    </article>
