...
/**
 * Title: Famubo Z Product 
 * 
 * Slug: themeslug/product-famubo-z
...
<!-- wp:group -->
<div class="wp-block-group product-page famubo-d-page">
    <!-- wp:group -->
    <div class="wp-block-group product-page-top">
        ...
        <div class="wp-block-group product-page-top-inner">
            ...
            <div class="wp-block-group product-page-top-left">
                <!-- wp:paragraph -->
                <p class="product-page-top-left-header">FAMUBO-Z</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p class="product-page-top-left-sub">ファンボ ゼット</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
            ...
            <div class="wp-block-group product-page-top-right">
                ...
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p class="product-page-top-right-header">USB接続</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p class="product-page-top-right-header">Wi-Fi</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
    ...
    <div class="wp-block-group product-header-title">
        ...
        <div class="wp-block-group product-header-list">
            ...
            <!-- wp:paragraph --><p class="product-title-header">FAMUBO-Z</p><!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-group product-intro">
        ...
        <div class="wp-block-group product-intro-inner">
            ...
            <figure class="wp-block-image size-large alignfull product-intro-logo">
                <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-z/f_logo_z.png' ) ); ?>" alt="超音波画像計測機器 USB&Wi-Fi接続「FAMUBO-Z」" class="wp-image-101"/></figure>
            <!-- /wp:image -->
            <!-- wp:paragraph --><p class="product-intro-sku">医療機器認証番号　304AKBZX00002000</p><!-- /wp:paragraph -->
            <!-- wp:paragraph --><p class="product-intro-title">リニア＆コンべックス Double Headの<br>高超小型マルチ機能超音波！</p><!-- /wp:paragraph -->
            <!-- wp:group -->
            <div class="wp-block-group product-intro-content">
                <!-- wp:group -->
                <div class="wp-block-group product-intro-content-item">
                    <!-- wp:paragraph --><p class="product-intro-content-read bold">FAMUBOシリーズにUSB＆Wi-fi 接続可能登場！</p><!-- /wp:paragraph -->
                    <!-- wp:paragraph --><p class="product-intro-content-read">リニア＆コンべックス　Double Headで使用可能。
こんな超音波が欲しかった！ 超小型マルチ機能超音波。
あらゆる環境や部位に対応。
Wi-fiが使えない環境ではUSBで接続可能。プローブの上下にリニア式とコンベックス式が付いており観察部位により使い分けが可能です。
FAMUBO以上の小型化がされており、院内での持ち運びや携帯、訪問に最適です。</p><!-- /wp:paragraph -->
                    <!-- wp:group -->
                    <div class="wp-block-group product-intro-content-video">
                        <!-- wp:video {"id":178} -->
                            <figure class="wp-block-video block-video"><video autoplay="" muted="" loop="" src="<?php echo esc_url( get_theme_file_uri( 'assets/videos/famubo/famuboZ01.mp4' ) ); ?>"></video></figure>
                        <!-- /wp:video -->
                    </div>
                    <!-- /wp:group -->
                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                    <figure class="wp-block-image size-large alignfull product-intro-content-image">
                        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-z/img01.png' ) ); ?>" alt="「FAMUBO-z」 超音波画像" class="wp-image-101"/>
                    </figure>
                    <!-- /wp:image -->
                </div>
                <!-- /wp:group -->
                ...
                <div class="wp-block-group product-intro-content-item content-right">
                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                    <figure class="wp-block-image size-large alignfull product-intro-content-image">
                        <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-z/body.jpg' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-W」" class="wp-image-101"/>
                    </figure>
                    <!-- /wp:image -->
                    <!-- wp:table -->
                    <figure class="wp-block-table product-intro-content-table">
                        <table class="has-fixed-layout">
                            ...
                            <tbody>
                                <tr>
                                    <td>サイズ</td>
                                    <td>本体<br>45(W)×20(H)×120(L) mm</td>
                                </tr>
                                <tr>
                                    <td>重　量</td>
                                    <td>0.3kg</td>
                                ...
                                <tr>
                                    <td>プローブ</td>
                                    <td>【CONVEX】2.5/5Mhz
                                    【Linear】7.5/10.0Mhz</td>
                                </tr>
                                <tr>
                                    <td>ヘッド幅</td>
                                    <td>45mmコンベックス　30mmリニア</td>
                                </tr>
                                <tr>
                                    <td>測定深度</td>
                                    <td>【CONVEX】 90-160mm 90-305mm
                                    【Linear】 20-100mm</td>
                                </tr>
                                <tr>
                                    <td>動作環境</td>
...
※一部機種に関しては推奨バージョン以上でも動作しない可能性がございます。</td>
    ...
    <!-- /wp:group -->
    <!-- wp:group -->
    <div class="wp-block-group product-default product-default-d">
        <!-- wp:group -->
        <div class="wp-block-group product-pdf">
            ...
            <div class="wp-block-group product-pdf-inner">
                ...
                <div class="wp-block-group product-information">
                    ...
                    <article class="wp-block-group product-information-item">
                        <!-- wp:group -->
                        <div class="wp-block-group product-information-banner-kv">
                            <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                            <figure class="wp-block-image size-large alignfull product-information-banner-kv-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-z/kv.png' ) ); ?>" alt="超音波画像計測機器 USB＆Wi-fi 接続可能「FAMUBO-z」" class="wp-image-101"/></figure>
                            <!-- /wp:image -->
                        </div>
                        <!-- /wp:group -->
                    </article>
        ...
        <div class="wp-block-group product-pdf">
            ...
            <div class="wp-block-group product-pdf-inner">
                ...
                <div class="wp-block-group product-information">
                    ...
                    <article class="wp-block-group product-information-item">
                        <!-- wp:group -->
                        <div class="wp-block-group product-information-physio">
                            <!-- wp:paragraph --><h3 class="product-information-physio-title">手軽に持ち運べるエコーで<br>様々なシチュエーションに対応</h3><!-- /wp:paragraph -->
                            <!-- wp:group -->
                            <div class="wp-block-group product-information-physio-content">
                                <!-- wp:group -->
                                <div class="wp-block-group product-information-physio-item">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                        <figure class="wp-block-image size-large alignfull product-information-physio-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo/situation_p01.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」カラードップラーで血流の流速変化を確認！" class="wp-image-101"/></figure>
                                    <!-- /wp:image -->
                                    <!-- wp:paragraph --><h4 class="product-information-physio-item-title">フィールド</h4><!-- /wp:paragraph -->
                                    <!-- wp:paragraph --><p class="product-information-physio-item-desc">アスリートにはケガがつきものですが、データ取得は選手寿命を守ります。</p><!-- /wp:paragraph -->
                                </div>
                                <!-- /wp:group -->
                                <!-- wp:group -->
                                <div class="wp-block-group product-information-physio-item">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                        <figure class="wp-block-image size-large alignfull product-information-physio-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo/situation_p02.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」カラードップラーで血流の流速変化を確認！" class="wp-image-101"/></figure>
                                    <!-- /wp:image -->
                                    <!-- wp:paragraph --><h4 class="product-information-physio-item-title">ロコモティブ</h4><!-- /wp:paragraph -->
                                    <!-- wp:paragraph --><p class="product-information-physio-item-desc">腹直筋1cm以下だと腰痛が発生しやすくなります。不良姿勢や腰のゆがみは筋力の低下が主な原因の一つです。</p><!-- /wp:paragraph -->
                                </div>
                                <!-- /wp:group -->
                                <!-- wp:group -->
                                <div class="wp-block-group product-information-physio-item">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                        <figure class="wp-block-image size-large alignfull product-information-physio-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo/situation_p03.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」カラードップラーで血流の流速変化を確認！" class="wp-image-101"/></figure>
                                    <!-- /wp:image -->
                                    <!-- wp:paragraph --><h4 class="product-information-physio-item-title">Observation</h4><!-- /wp:paragraph -->
                                    <!-- wp:paragraph --><p class="product-information-physio-item-desc">お客様は体の中（脂肪、筋、骨）についてよく知りません。超音波による観察と説明はお客様に十分な納得と安心を与えます。</p><!-- /wp:paragraph -->
                                </div>
                                <!-- /wp:group -->
                                <!-- wp:group -->
                                <div class="wp-block-group product-information-physio-item">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                        <figure class="wp-block-image size-large alignfull product-information-physio-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo/situation_p04.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」カラードップラーで血流の流速変化を確認！" class="wp-image-101"/></figure>
                                    <!-- /wp:image -->
                                    <!-- wp:paragraph --><h4 class="product-information-physio-item-title">学校教育</h4><!-- /wp:paragraph -->
                                    <!-- wp:paragraph --><p class="product-information-physio-item-desc">LIVEで各部位の画像観察をしてみましょう。ワイヤレスで個別指導にも便利です。</p><!-- /wp:paragraph -->
                                </div>
                                <!-- /wp:group -->
                                <!-- wp:group -->
                                <div class="wp-block-group product-information-physio-item">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                        <figure class="wp-block-image size-large alignfull product-information-physio-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo/situation_p05.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」カラードップラーで血流の流速変化を確認！" class="wp-image-101"/></figure>
                                    <!-- /wp:image -->
                                    <!-- wp:paragraph --><h4 class="product-information-physio-item-title">トレーニング</h4><!-- /wp:paragraph -->
                                    <!-- wp:paragraph --><p class="product-information-physio-item-desc">トレーニングによって筋量・筋厚のデータの経過観察をしましょう。</p><!-- /wp:paragraph -->
                                </div>
                                <!-- /wp:group -->
                                <!-- wp:group -->
                                <div class="wp-block-group product-information-physio-item">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                        <figure class="wp-block-image size-large alignfull product-information-physio-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo/situation_p06.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」カラードップラーで血流の流速変化を確認！" class="wp-image-101"/></figure>
                                    <!-- /wp:image -->
                                    <!-- wp:paragraph --><h4 class="product-information-physio-item-title">カウンセリング</h4><!-- /wp:paragraph -->
                                    <!-- wp:paragraph --><p class="product-information-physio-item-desc">現在と10年後のお客様を説明してください。運動や食事等の指導も元気で長生きするための重要なファクターです。</p><!-- /wp:paragraph -->
                                </div>
                                <!-- /wp:group -->
                                <!-- wp:group -->
                                <div class="wp-block-group product-information-physio-item">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                        <figure class="wp-block-image size-large alignfull product-information-physio-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo/situation_p07.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」カラードップラーで血流の流速変化を確認！" class="wp-image-101"/></figure>
                                    <!-- /wp:image -->
                                    <!-- wp:paragraph --><h4 class="product-information-physio-item-title">メタボ指導</h4><!-- /wp:paragraph -->
                                    <!-- wp:paragraph --><p class="product-information-physio-item-desc">腰痛、膝痛は過体重が主な要因です。皮下脂肪の付き方、筋肉の厚さを超音波画像をお見せして説明してください。</p><!-- /wp:paragraph -->
                                </div>
                                <!-- /wp:group -->
                            </div>
                            <!-- /wp:group -->
    ...
    そして「Health Related Fitness Physical test」の論文に記載のように超音波Ｂモードと水中表秤法により体脂肪率の新たな計算式が発表されＲＡＴＥ＝９０の信頼性のある測定機器として健康指導、運動指導、ダイエット指導、栄養指導等に使われるようになりました。体脂肪率の正確さ、画像で見られる皮下脂肪双方を取り入れた画期的な開発と言えます。</p><!-- /wp:paragraph -->
                    ...
                    <article class="wp-block-group product-information-item">
                        ...
                        <div class="wp-block-group product-information-item-title">
                            <!-- wp:paragraph --><p class="product-information-item-title-header">■ FOCUS POS機能</p><!-- /wp:paragraph -->
                            <!-- wp:paragraph --><p class="product-information-item-title-sub">7.5-10.0MHz/192素子で高画質</p><!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:group -->
                        <!-- wp:group -->
                        <div class="wp-block-group product-information-item-focus">
                            <!-- wp:paragraph --><p class="product-information-item-focus-title">画像深度レベルを4段階で選択可能、各部位ごとにフォーカスを2ヶ所で合わせノイズを低減し、クリアな画質で映し出します。192素子で細部を鮮明に撮れるようになりました</p><!-- /wp:paragraph -->
                            <!-- wp:group -->
                            <div class="wp-block-group product-information-item-focus-content">
                                ...
                                <div class="wp-block-group product-information-item-focus-detail">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                    <figure class="wp-block-image size-large alignfull product-information-item-focus-content-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-d/img01.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」高画質カラーで流速変化を確認" class="wp-image-101"/>
                                    </figure>
                                    <!-- /wp:image -->
                                </div>
                                <!-- /wp:group -->
                                ...
                                <div class="wp-block-group product-information-item-focus-detail">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                    <figure class="wp-block-image size-large alignfull product-information-item-focus-content-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-d/img02.png' ) ); ?>" alt="超音波画像計測機器 カラードップラー「FAMUBO-D」高画質カラーで流速変化を確認" class="wp-image-101"/>
                                    </figure>
                                    <!-- /wp:image -->
                                </div>
                                <!-- /wp:group -->
                    ...
                    <article class="wp-block-group product-information-item">
                        ...
                        <div class="wp-block-group product-information-list-topic">
                            ...
                            <div class="wp-block-group product-information-item-topic">
                                ...
                                <div class="wp-block-group product-topic-link">
                                    <!-- wp:video {"id":178} -->
                                    <figure class="wp-block-video block-video"><video autoplay="" muted="" loop="" src="https://mv.seikosha-net.co.jp/famubo/famuboZ01.mp4"></video></figure>
                                    <!-- /wp:video -->
                                </div>
                                <!-- /wp:group -->
                                <!-- wp:paragraph --><p class="product-information-item-topic-title">FAMUBO-Z コンベックス</p><!-- /wp:paragraph -->
                            </div>
                            <!-- /wp:group -->
                            <!-- wp:group -->
                            <div class="wp-block-group product-information-item-topic">
                    ...
                    <article class="wp-block-group product-information-item">
                        <!-- wp:group -->
                        <div class="wp-block-group product-information-item-title">
                            <!-- wp:paragraph --><p class="product-information-item-title-header">■ セミナー</p><!-- /wp:paragraph -->
                            <!-- wp:paragraph --><p class="product-information-item-title-sub">FAMUBO-Z</p><!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:group -->
                        <!-- wp:group -->
                        <div class="wp-block-group product-information-list-famubo-z">
                            <!-- wp:group -->
                            <div class="wp-block-group product-information-famubo-z-content">
                                <!-- wp:group -->
                                <div class="wp-block-group product-information-item-famubo">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                    <figure class="wp-block-image size-large alignfull product-information-item-famubo-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-z/seminar01.jpg' ) ); ?>" alt="F鍼の感覚を視覚化するセミナー FAMUBO-Z" class="wp-image-101"/>
                                    </figure>
                                    <!-- /wp:image -->
                                </div>
                                <!-- /wp:group -->
                                ...
                                <div class="wp-block-group product-information-item-famubo">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                    <figure class="wp-block-image size-large alignfull product-information-item-famubo-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-z/seminar02.jpg' ) ); ?>" alt="鍼の感覚を視覚化するセミナー FAMUBO-Z" class="wp-image-101"/>
                                    </figure>
                                    <!-- /wp:image -->
                                </div>
                                <!-- /wp:group -->
                                ...
                                <div class="wp-block-group product-information-item-famubo">
                                    <!-- wp:image {"id":101,"sizeSlug":"large","linkDestination":"none"} -->
                                    <figure class="wp-block-image size-large alignfull product-information-item-famubo-image"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/products/famubo-z/seminar03.jpg' ) ); ?>" alt="鍼の感覚を視覚化するセミナー FAMUBO-Z" class="wp-image-101"/>
                                    </figure>
                                    <!-- /wp:image -->
                                </div>
                                <!-- /wp:group -->
                            ...
                            <!-- /wp:group -->
                            <!-- wp:paragraph --><p class="product-information-item-famubo-header">自分の感覚をエコーで再認識！ 鍼灸氏の卵もベテラン鍼灸師も初心に戻ってスキルアップ！</p><!-- /wp:paragraph -->
                            <!-- wp:paragraph --><p class="product-information-item-famubo-title">「鍼の感覚を視覚化するセミナー」</p><!-- /wp:paragraph -->
                            <!-- wp:paragraph --><p class="product-information-item-famubo-detail">2021年5月2日に誠鋼社2階オプティマススタジオで行われました。<br>
                セミナー講師は鍼灸師按摩マッサージ指圧師 樋口尚生先生（<a href="https://www.higuchi-sinkyu-in-2017.com/" target="_blank" class="link_cl">Higuchi鍼灸院</a>）</p><!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:group -->
                    </article>
                    <!-- /wp:group -->
